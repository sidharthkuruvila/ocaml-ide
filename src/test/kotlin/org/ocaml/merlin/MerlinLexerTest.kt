...
class MerlinLexerTest {
    ...
    fun testLexing() {
        ...
        val expected = listOf(
                ...
                TokenValue(type = "TRY", text = "try", start = 4, end = 7),
                TokenValue(type = "WHITESPACE", text = " ", start = 7, end = 8),
                TokenValue(type = "LIDENT", text = "ignore", start = 8, end = 14),
                TokenValue(type = "WHITESPACE", text = "\n        ", start = 14, end = 23),
                TokenValue(type = "LIDENT", text = "identifier", start = 23, end = 33),
                TokenValue(type = "WHITESPACE", text = " ", start = 33, end = 34),
                TokenValue(type = "LIDENT", text = "x", start = 34, end = 35),
                ...
                TokenValue(type = "WHITESPACE", text = "\n        ", start = 92, end = 101),
                TokenValue(type = "STRING", text = "\"hello world\"", start = 101, end = 114),
                TokenValue(type = "WHITESPACE", text = "\n        ", start = 114, end = 123),
                TokenValue(type = "LIDENT", text = "a", start = 123, end = 124),
                TokenValue(type = "DOT", text = ".", start = 124, end = 125),
                TokenValue(type = "LIDENT", text = "b", start = 125, end = 126),
                TokenValue(type = "WHITESPACE", text = "\n        ", start = 126, end = 135),
